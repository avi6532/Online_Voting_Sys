...
<div class="container">
	<div class="col-md-6 col-md-offset-3">
		...
		<p class="text text-danger">In This Section those election result will display which are compeleted</p>
		<form method="POST">
		<div class="form-group">
			<select class="form-control" name="elections_name">
				<option class="form-control" selected="selected" value="">Select Election</option>
				<?php
				$current_ts=time();
